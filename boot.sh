...
mkdir -p /opt/conda/anaconda/envs/moove-dataproc/lib/python3.6/site-packages/moovemodules
# Install custom moove-modules repo (location found with pip show geopandas)
